...
public class CartsController : ControllerBase
{
    ...
    public async Task<IActionResult> AddItemAsync(AddItemRequest req)
    {
        ...
        try
        {
            var cartDTO = await _cartsService.AddItemAsync(cartId, req.ItemId, req.Quantity);
            return Ok(cartDTO);
        }
        catch
        {
    ...
    public async Task<IActionResult> DeleteItemAsync(string itemId)
    {
        ...
        try
        {
            var cartDTO = await _cartsService.DeleteItemAsync(cartId, itemId);
            return Ok(cartDTO);
        }
        catch
        {
    ...
    public async Task<IActionResult> GetAsync()
    {
        ...
        try
        {
            var cartDTO = await _cartsService.GetItemsAsync(cartId);
            return Ok(cartDTO);
        }
        catch
        {
    ...
    public async Task<IActionResult> UpdateItemAsync(UpdateItemRequest req)
    {
        ...
        try
        {
            var cartDTO = await _cartsService.UpdateItemAsync(cartId, req.ItemId, req.Quantity);
            return Ok(cartDTO);
        }
        catch
        {
